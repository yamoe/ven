...
namespace ven {
  ...
  public:
    ...
    ui32_t accept_cnt_ = 200;  // accept 걸어둘 세션 수
    ui32_t session_pre_cnt_ = 200;  // 미리 생성할 세션 수
    ui32_t session_inc_cnt_ = 100;  // 세션 증가 단위
    ui32_t session_max_cnt_ = 20000;  // 최대 세션 수
